...
{
    public class AbilityActivationRequestHandlerSystem
        : IEcsInitSystem,
          IEcsRunSystem,
          IEcsPostRunSystem
    {
        ...
        public void Init(IEcsSystems systems)
        {
            ...
            filter = world.Filter<AbilityComponent>().Inc<ActivationRequestComponent>().End();
            canBeActivatedFilter = world.Filter<AbilityComponent>().Inc<CanBeActivatedFlagComponent>().End();
